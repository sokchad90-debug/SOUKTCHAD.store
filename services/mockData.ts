...
export const paymentMethods: PaymentMethod[] = [
  { id: 'airtel', name: 'Airtel Money', logo: '', color: '#E4002B', instructions: 'Dial *222# > Send Money > Enter number > Enter amount > Confirm with PIN' },
  { id: 'moov', name: 'Moov Money', logo: '', color: '#0066CC', instructions: 'Dial *155# > Transfer > Enter number > Enter amount > Confirm with PIN' },
  { id: 'cod', name: 'Cash on Delivery', logo: '', color: '#059669', instructions: 'Pay cash directly to the seller upon receiving the item at the agreed location.' },
];

export const sellers: Seller[] = [
  {
    id: 'seller1', name: 'Moussa Electronics', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop',
    sellerId: 'Sok-84729', isVerified: true, verifiedUntil: '2025-06-15', isBanned: false, location: "N'Djamena", rating: 4.8, totalSales: 156,
    joinedDate: '2023-03-15', phone: '+235 66 XX XX XX', isOnline: true,
    paymentMethods: [{ methodId: 'airtel', receivingNumber: '66 12 34 56' }, { methodId: 'moov', receivingNumber: '99 78 90 12' }],
  },
  {
    id: 'seller2', name: 'Fatima Fashion', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&h=200&fit=crop',
    sellerId: 'Sok-31056', isVerified: true, verifiedUntil: '2025-09-20', isBanned: false, location: 'Moundou', rating: 4.9, totalSales: 89,
    joinedDate: '2023-06-20', phone: '+235 99 XX XX XX', isOnline: false, lastSeen: '2026-02-26T08:30:00Z',
    paymentMethods: [{ methodId: 'airtel', receivingNumber: '66 98 76 54' }],
  },
  {
    id: 'seller3', name: 'Ibrahim Motors', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop',
    sellerId: 'Sok-67283', isVerified: false, isBanned: false, location: "N'Djamena", rating: 4.5, totalSales: 34,
    joinedDate: '2024-01-10', phone: '+235 68 XX XX XX', isOnline: true,
    paymentMethods: [{ methodId: 'airtel', receivingNumber: '68 11 22 33' }, { methodId: 'cod', receivingNumber: 'N/A' }],
  },
  {
    id: 'seller4', name: 'Aisha Home & Decor', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&h=200&fit=crop',
    sellerId: 'Sok-45901', isVerified: false, isBanned: false, location: 'Abéché', rating: 4.6, totalSales: 67,
    joinedDate: '2023-09-05', phone: '+235 90 XX XX XX', isOnline: false, lastSeen: '2026-02-25T18:00:00Z',
    paymentMethods: [{ methodId: 'moov', receivingNumber: '90 44 55 66' }],
  },
  {
    id: 'seller5', name: 'Hassan Agri-Supply', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&h=200&fit=crop',
    sellerId: 'Sok-12478', isVerified: true, verifiedUntil: '2025-11-01', isBanned: false, location: 'Sarh', rating: 4.7, totalSales: 45,
    joinedDate: '2023-11-01', phone: '+235 77 XX XX XX', isOnline: true,
...
export const products: Product[] = [
  {
    ...
    price: 185000, images: ['https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=600&h=600&fit=crop'],
  ...
  },
  {
    ...
    price: 650000, images: ['https://images.unsplash.com/photo-1678685888221-cda773a3dcdb?w=600&h=600&fit=crop'],
  ...
  },
  {
    ...
    price: 8500000, images: ['https://images.unsplash.com/photo-1621007947382-bb3c3994e3fb?w=600&h=600&fit=crop'],
  ...
  },
  {
    ...
    price: 55000, images: ['https://images.unsplash.com/photo-1549298916-b41d501d3779?w=600&h=600&fit=crop'],
    categoryId: 'shoes', sellerId: 'seller3', condition: 'used', location: "N'Djamena",
  ...
  },
  {
    ...
    price: 25000, images: ['https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=600&h=600&fit=crop'],
  ...
  },
  {
    ...
    price: 45000, images: ['https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&h=600&fit=crop'],
  ...
  },
  {
    ...
    price: 45000000, images: ['https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&h=600&fit=crop'],
  ...
  },
  {
    ...
    price: 75000, images: ['https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600&h=600&fit=crop'],
  ...
  },
  {
    ...
    price: 150000, images: ['https://images.unsplash.com/photo-1509391366360-2e959784a276?w=600&h=600&fit=crop'],
  ...
  },
  {
    ...
    price: 280000, images: ['https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600&h=600&fit=crop'],
  ...
  },
  {
    ...
    price: 120000, images: ['https://images.unsplash.com/photo-1586771107445-b3e7eb3f3a12?w=600&h=600&fit=crop'],
  ...
  },
  {
    ...
    price: 95000, images: ['https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&h=600&fit=crop'],
    categoryId: 'agriculture', sellerId: 'seller5', condition: 'new', location: 'Sarh',
  ...
  },
  {
    ...
    price: 35000, images: ['https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=600&h=600&fit=crop'],
    categoryId: 'electronics', sellerId: 'seller1', condition: 'new', location: "N'Djamena",
  ...
  },
  {
    ...
    price: 320000, images: ['https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=600&h=600&fit=crop'],
    categoryId: 'electronics', sellerId: 'seller1', condition: 'new', location: "N'Djamena",
  ...
  },
  {
    ...
    price: 4200000, images: ['https://images.unsplash.com/photo-1549317661-bd32c8ce0afa?w=600&h=600&fit=crop'],
  ...
  },
  {
    ...
    price: 18000, images: ['https://images.unsplash.com/photo-1590736969955-71cc94901144?w=600&h=600&fit=crop'],
    categoryId: 'fashion', sellerId: 'seller2', condition: 'new', location: 'Moundou',
  ...
  },
  {
    ...
    price: 150000, images: ['https://images.unsplash.com/photo-1582037928769-181f2644ecb7?w=600&h=600&fit=crop'],
    categoryId: 'real_estate', sellerId: 'seller4', condition: 'used', location: "N'Djamena",
  ...
  },
  {
    ...
    price: 195000, images: ['https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=600&h=600&fit=crop'],
    categoryId: 'home_garden', sellerId: 'seller4', condition: 'new', location: 'Abéché',
  ...
  },
  {
    ...
    price: 8500, images: ['https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&h=600&fit=crop'],
    categoryId: 'agriculture', sellerId: 'seller5', condition: 'new', location: 'Sarh',
  ...
  },
  {
    ...
    price: 285000, images: ['https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=600&h=600&fit=crop'],
    categoryId: 'electronics', sellerId: 'seller1', condition: 'new', location: "N'Djamena",
  ...
  },
  {
    ...
    price: 350000, images: ['https://images.unsplash.com/photo-1519741497674-611481863552?w=600&h=600&fit=crop'],
  ...
  },
  {
    ...
    price: 275000, images: ['https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=600&h=600&fit=crop'],
...
export const mockReviews: Review[] = [
  {
    ...
    photoUri: 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=300&h=300&fit=crop',
...
export const conversations: Conversation[] = [
  {
    id: 'conv1', buyerId: 'user1', sellerId: 'seller1', productId: 'p1',
    messages: [
      { id: 'm1', senderId: 'user1', text: 'Is this phone still available?', type: 'text', timestamp: '2024-12-15T10:00:00Z' },
      { id: 'm2', senderId: 'seller1', text: 'Yes, it is! Brand new sealed box.', type: 'text', timestamp: '2024-12-15T10:02:00Z' },
      { id: 'm3', senderId: 'user1', text: 'Can you do 170,000 FCFA?', type: 'text', timestamp: '2024-12-15T10:05:00Z' },
      { id: 'm4', senderId: 'seller1', text: 'Best I can do is 180,000. Final price.', type: 'text', timestamp: '2024-12-15T10:08:00Z' },
    ],
    lastMessage: 'Best I can do is 180,000. Final price.',
    lastMessageTime: '2024-12-15T10:08:00Z',
    unreadCount: 1,
  },
  {
    id: 'conv2', buyerId: 'user1', sellerId: 'seller2', productId: 'p5',
    messages: [
      { id: 'm5', senderId: 'user1', text: 'Do you have this in XL size?', type: 'text', timestamp: '2024-12-14T14:00:00Z' },
      { id: 'm6', senderId: 'seller2', text: 'Yes we do! Available in white and blue.', type: 'text', timestamp: '2024-12-14T14:15:00Z' },
      { id: 'm8', senderId: 'seller2', text: "I will prepare blue XL for you. When do you need it?", type: 'text', timestamp: '2024-12-14T14:25:00Z' },
    ],
    lastMessage: "I will prepare blue XL for you. When do you need it?",
    lastMessageTime: '2024-12-14T14:25:00Z',
    unreadCount: 0,
  },
  {
    id: 'conv3', buyerId: 'user1', sellerId: 'seller3', productId: 'p3',
    messages: [
      { id: 'm9', senderId: 'user1', text: 'Is the Toyota still available?', type: 'text', timestamp: '2024-12-10T09:00:00Z' },
      { id: 'm10', senderId: 'seller3', text: 'Yes! Want to see it in person? Available any day.', type: 'text', timestamp: '2024-12-10T09:30:00Z' },
    ],
    lastMessage: 'Yes! Want to see it in person? Available any day.',
    lastMessageTime: '2024-12-10T09:30:00Z',
    unreadCount: 0,
  },
];

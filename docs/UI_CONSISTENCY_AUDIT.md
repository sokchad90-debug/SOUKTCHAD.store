...
- fs200: نفس العقدة 138px = **50.2dp** = سطران × ~25dp ≈ 13.8 × **1.35** (سقف maxFontSizeMultiplier يعمل)
- النتيجة: عند 200% يعمل التكبير الفعلي بحد أقصى 1.35×، السعر يلتف لسطرين ويظل ظاهراً كاملاً (إثبات بصري سابق fs200).

    ...
    try {
      const demoUser = type === 'seller'
        ? {
            ...
            avatar: 'https://souktchad.shop/dl/products/photo-1507003211169-0a1dd7228f2d.jpg',
            coverImage: 'https://souktchad.shop/dl/products/photo-1557683316-973673baf926.jpg',
        ...
        : {
            ...
            avatar: 'https://souktchad.shop/dl/products/photo-1494790108377-be9c29b29330.jpg',
            coverImage: 'https://souktchad.shop/dl/products/photo-1557683316-973673baf926.jpg',
            role: 'buyer' as const,
            isSeller: false,
            isVerified: false,
      ...
      // IMPORTANT: merge with existing saved user data so logo/banner changes survive logout
      try {
        const existingUser = await AsyncStorage.getItem('sokchad_user');
        const existing = existingUser ? JSON.parse(existingUser) : {};
        // Keep locally-uploaded avatar/coverImage if they exist
        const mergedUser = {
          ...demoUser,
          avatar: existing.avatar_url || existing.avatar || demoUser.avatar,
          coverImage: existing.cover_url || existing.coverImage || demoUser.coverImage,
          avatar_url: existing.avatar_url || existing.avatar || demoUser.avatar,
          cover_url: existing.cover_url || existing.coverImage || demoUser.coverImage,
          paymentMethods: existing.paymentMethods || demoUser.paymentMethods,
        };
        await AsyncStorage.setItem('sokchad_user', JSON.stringify(mergedUser));
      } catch (e) {
